...
- Repo link: https://github.com/YouttyLe-DSAI/Lab13-Observability
...
### 3.1 Logging & Tracing
- EVIDENCE_CORRELATION_ID_SCREENSHOT: ![alt text](/docs/screen/{DFF0164F-2FB8-4821-B4F8-65999C67998B}.png)
- EVIDENCE_PII_REDACTION_SCREENSHOT: ![alt text](/docs/screen/image-2.png)
- EVIDENCE_TRACE_WATERFALL_SCREENSHOT: [/docs/screen/trace_waterfall.png]
...
### 3.2 Dashboard & SLOs
- DASHBOARD_6_PANELS_SCREENSHOT: ![alt text](/docs/screen/image.png)
...
### 3.3 Alerts & Runbook
- ALERT_RULES_SCREENSHOT: ![alt text](/docs/screen/image_copy.png)
...
- [![alt text](/docs/screen/image-3.png)], ![ ](/docs/screen/image-4.png): [app/middleware.py], [app/pii.py]
...
- ![alt text](/docs/screen/image-5.png): [app/agent.py], [app/metrics.py]
### [Cao Diệu Ly]
- TASKS_COMPLETED: Tạo 6 Chart Panel (Latency, Cost, Error...); Viết Alert Rules; Chạy load_test.py để lấy dữ liệu thực tế.
- ![alt text](/docs/screen/image.png),![alt text](/docs/screen/image-1.png) 
### [Lê Minh Tuấn]
- TASKS_COMPLETED: Chạy validate_logs.py kiểm tra điểm; Phân tích sự cố (Incident Response); Hoàn thiện Report và dẫn dắt Demo.
- ![alt text](/docs/screen/{89492C60-118A-4A90-BE85-8ACCF731759C}.png): docs/blueprint-template.md, scripts/trigger_alerts.py
